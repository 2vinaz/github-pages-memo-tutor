...
학습자는 Claude 데스크탑 앱에서 튜터와 짧은 제품 인터뷰를 하며 What, Who, Behavior, Errors, Out of Scope, Design을 정하고, 그 답변이 실제 화면과 디자인에 반영되는 과정을 함께 봅니다. Claude가 파일을 만들고 명령을 실행하며, 학습자는 말로 답하고 브라우저에서 GitHub 설정과 배포된 웹사이트를 확인합니다.
